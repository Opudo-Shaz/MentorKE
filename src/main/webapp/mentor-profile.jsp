...
<%
    ...
    String mentorExp    = mentor != null && mentor.getYearsOfExperience() != null ? mentor.getYearsOfExperience() + " yrs" : "—";
    ...
    String encodedSpec  = java.net.URLEncoder.encode(mentorSpec.equals("—") ? "" : mentorSpec, java.nio.charset.StandardCharsets.UTF_8);
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .mentor-name-lg { font-size: 18px; font-weight: 600; color: var(--gray-800); margin-bottom: 4px; }
        .mentor-spec-lg { font-size: 14px; color: var(--gray-400); margin-bottom: 16px; }
        ...
        /* info boxes */
        .info-box { background: var(--blue-25); border-left: 3px solid var(--blue-200); border-radius: 0 var(--radius-md) var(--radius-md) 0; padding: 12px 14px; font-size: 13px; color: var(--gray-600); line-height: 1.7; margin-bottom: 14px; }
        .info-box:last-child { margin-bottom: 0; }
        .info-box-label { font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.06em; color: var(--blue-800); margin-bottom: 6px; }
...
<div class="main">
    ...
    <div class="topbar">
        <div>
            ...
            <p><%= mentor != null ? mentorName : "Profile not found" %></p>
        </div>
    ...
    <div class="content">
        ...
        <div class="profile-grid">
            ...
            <div>
                        ...
                        <div>
                            <div class="detail-row">
                                ...
                                <div>
                                    ...
                                    <div class="detail-val"><%= mentorExp %></div>
                                </div>
                            </div>
                            <div class="detail-row">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/></svg>
                ...
                <!-- action buttons below identity card -->
                <div class="action-row">
                    <a class="btn-primary" href="<%= ctx %>/app/mentee-sessions/request?mentorId=<%= mentor.getId() %>&specialization=<%= encodedSpec %>">
            ...
            <div style="display:flex; flex-direction:column; gap:20px;">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p>Background and professional bio</p>
                    </div>
                    <div class="card-body">
                        <div class="info-box">
                            <div class="info-box-label">Bio</div>
                            <%= mentorBio %>
                        </div>
                    </div>
                </div>

                <!-- Qualifications & Expertise (only if present) -->
                <% if (mentorQual != null || mentorExp2 != null) { %>
                <div class="card">
                    <div class="card-header">
                        <h2>Qualifications &amp; expertise</h2>
                        <p>Credentials and areas of knowledge</p>
                    </div>
                    <div class="card-body">
                        <% if (mentorQual != null) { %>
                        <div class="info-box">
                            <div class="info-box-label">Qualifications</div>
                            <%= mentorQual %>
                        </div>
                        <% } %>
                        <% if (mentorExp2 != null) { %>
                        <div style="margin-top: <%= mentorQual != null ? "14px" : "0" %>;">
                            <div style="font-size:12px; font-weight:600; color:var(--gray-400); text-transform:uppercase; letter-spacing:0.06em; margin-bottom:10px;">Expertise areas</div>
                            <div class="tag-row">
                                <%
