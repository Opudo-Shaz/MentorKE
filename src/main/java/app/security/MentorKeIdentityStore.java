...
@ApplicationScoped
public class MentorKeIdentityStore implements IdentityStore, MentorKeIdentityStore11 {

    private static final Logger logger = AppLogger.getLogger(MentorKeIdentityStore.class);
